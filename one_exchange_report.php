...
if (isset($_POST["report"])) {
    ...
    $query_sel_ex = "SELECT ex_code, s_full_name, name as b_name, amount, tax, r_amount, profit, achived, s_date, r_date FROM exchange INNER JOIN branch ON exchange.r_b_id=branch.b_id WHERE s_date LIKE '$year-$month%' AND (exchange.s_b_id=$b_id OR exchange.r_b_id=$b_id)";
    ...
    <li class="current"><a href=""><i class="fa fa-inbox"></i> Monthly Reports</a>
        <ul>
            ...
            <li class="divider current"><a href=""><i class="fa fa-paste"></i> One Branche</a>
                <ul>
                    <li class="current"><a href="one_exchange_report.php"><i class="fa fa-refresh"></i> Transfers</a></li>
