...
if (isset($_POST["report"])) {
    ...
    $query_sel_ex = "SELECT ex_code, s_full_name, name as b_name, amount, tax, r_amount, profit, achived, s_date, r_date FROM exchange INNER JOIN branch ON exchange.r_b_id=branch.b_id WHERE s_date LIKE '$year-$month%' AND achived='yes'";
            ...
            <li class="current"><a href=""><i class="fa fa-paste"></i> All Branches</a>
                <ul>
                    ...
                    <li class="current"><a href=""><i class="fa fa-coffee"></i> Achived</a>
                        <ul>
                            <li class="current"><a href="all_achieved_report.php"><i class="fa fa-check"></i> Yes</a></li>
