...
if (isset($_POST["report"])) {
    ...
    $query_sel_ex = "SELECT SUM(profit) AS total_profit FROM exchange WHERE s_date LIKE '$year-$month%'  AND (exchange.s_b_id=$b_id OR exchange.r_b_id=$b_id)";
        ...
        <ul>
            ...
            <li class="divider current"><a href=""><i class="fa fa-paste"></i> One Branche</a>
                <ul>
                    ...
                    <li class="current"><a href="one_profit_report.php"><i class="fa fa-camera-retro"></i> Profit</a></li>
...
<div class="grid">
    <fieldset>
        <legend>Profit Report of Year: <b><?= $_POST["report_year"] ?></b> and Month: <b><?= $_POST["report_month"]; ?></b></legend>
