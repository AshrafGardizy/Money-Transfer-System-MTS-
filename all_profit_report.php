...
if (isset($_POST["report"])) {
    ...
    $query_sel_ex = "SELECT SUM(profit) AS total_profit FROM exchange WHERE s_date LIKE '$year-$month%'";
        ...
        <ul>
            <li class="current"><a href=""><i class="fa fa-paste"></i> All Branches</a>
                <ul>
                    ...
                    <li class="current"><a href="all_profit_report.php"><i class="fa fa-camera-retro"></i> Profit</a></li>
