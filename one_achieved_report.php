...
// Select all the Braches
$query_sel_b = "SELECT * FROM branch";
...
if (isset($_POST["report"])) {
    ...
    $query_sel_ex = "SELECT ex_code, s_full_name, name as b_name, amount, tax, r_amount, profit, achived, s_date, r_date FROM exchange INNER JOIN branch ON exchange.r_b_id=branch.b_id WHERE s_date LIKE '$year-$month%' AND achived='yes' AND (s_b_id='$b_id' OR r_b_id='$b_id')";
...
<ul class="menu">
    ...
    <li class="current"><a href=""><i class="fa fa-inbox"></i> Monthly Reports</a>
        <ul>
            ...
            <li class="divider current"><a href=""><i class="fa fa-paste"></i> One Branche</a>
                <ul>
                    ...
                    <li class="current"><a href=""><i class="fa fa-coffee"></i> Achived</a>
                        <ul>
                            <li class="current"><a href="one_achieved_report.php"><i class="fa fa-check"></i> Yes</a></li>
...
<div class="grid">
    ...
    <?php } ?>
    <fieldset>
        <legend>Monthly Achieved Report Form</legend>
        <form method="post">
            <div class="col_12">
                <label for="branch" class="col_1">Select Branch:</label>
                <select class="input-lg col_10" id="branch" name="b_id">
                    <?php while ($row = $sel_b->fetch_object()) { ?>
...
<div class="grid">
    <fieldset>
        <legend>Monthly Achieved Report of Year: <b><?= $_POST["report_year"] ?></b> and Month: <b><?= $_POST["report_month"]; ?></b></legend>
