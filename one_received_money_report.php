...
if (isset($_POST["report"])) {
    ...
    $query_sel_ex = "SELECT ex_code, s_full_name, name as b_name, amount, tax, r_amount, profit, achived, s_date, r_date FROM exchange INNER JOIN branch ON exchange.r_b_id=branch.b_id WHERE s_date LIKE '$year-$month%' AND r_b_id='$b_id'";
        ...
        <ul>
            ...
            <li class="divider current"><a href=""><i class="fa fa-paste"></i> One Branche</a>
                <ul>
                    ...
                    <li class="current"><a href="one_received_money_report.php"><i class="fa fa-sign-in"></i> Received Money</a></li>
                    <li><a href=""><i class="fa fa-coffee"></i> Achived</a>
                        <ul>
...
<div class="grid">
    ...
    <?php } ?>
    <fieldset>
        <legend>Monthly Received Report Form</legend>
        <form method="post">
            <div class="col_12">
...
<div class="grid">
    <fieldset>
        <legend>Monthly Received Report of Year: <b><?= $_POST["report_year"] ?></b> and Month: <b><?= $_POST["report_month"]; ?></b></legend>
