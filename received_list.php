...
$query_sel_ex = "SELECT * FROM exchange WHERE r_b_id='$logger_row->b_id'";
...
<ul class="menu">
    ...
    <li class="current"><a href=""><i class="fa fa-inbox"></i> Recieved Money 
        ...
        <ul>
            <li class="current"><a href="received_list.php"><i class="fa fa-list-alt"></i> Received List</a></li>
...
<div class="grid">
    <fieldset>
    <legend>Money Received Lists</legend>
