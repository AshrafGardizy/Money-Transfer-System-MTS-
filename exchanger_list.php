...
// Select All Exchanger
$query_sel_ex = "SELECT employee.emp_id, firstname, lastname, phone, email, name FROM employee LEFT JOIN branch ON employee.b_id=branch.b_id WHERE position='exchanger'";
...
<ul class="menu">
    ...
    <li class="current"><a href=""><i class="fa fa-desktop"></i> Employee Reports</a>
        <ul>
            ...
            <li class="divider current"><a href="exchanger_list.php"><i class="fa fa-list-alt"></i> Exchanger Lists</a></li>
        </ul>
    </li>
...
<div class="grid">
    ...
    <legend>Exchanger Lists</legend>
        <table class="striped">
            ...
            <?php $no = 1; while ($row = $sel_ex->fetch_object()) { ?>
            <tr>
                <td><?= $no; ?></td>
                <td><?= $row->firstname; ?></td>
                <td><?= $row->lastname; ?></td>
